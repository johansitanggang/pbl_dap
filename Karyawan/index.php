            ...
            <main>
                <div class="container-fluid">
                    <div class="row" id="db">
                        <div class="col-md mt-3 mb-2">
                            <div class="bg-mattOrangeLight px-3 pt-3 pb-1">
                                ...
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam qui porro amet ut
                                    delectus cum ea
                                    tempora magnam iusto numquam impedit voluptate distinctio vel eos quasi odit, quia
                                    voluptatibus
                                    consequuntur assumenda sequi molestias corporis voluptas rerum! Laboriosam beatae
                                    officia cupiditate
                        ...
                        <div class="col-md mt-3 mb-2">
                            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                                <div class="carousel-inner">
                                    ...
                                    <!-- Slide 3 -->
                                    <div class="carousel-item" data-interval="2000">
                                        <img src="https://metro.batampos.co.id/wp-content/uploads/2022/06/1-HL-Polibatam-Zona-Integritas-PWBB.-F-Polibatam-1-scaled-e1655355264389.jpg"
                                            class="d-block mx-auto img-fluid" alt="..."
                                            style="max-height: 400px; max-width: 1000px; width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                                </div>
                    ...
                    <div class="row" id="lpr">
                        <div class="col-md mt-3 mb-2">
                            <div class="bg-mattOrangeLight px-3 pt-3 pb-1">
                                <h1 class="mb-2" align="center">LAPORAN</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <form>
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="tahun"
                                            placeholder="Masukkan tahun" min="2000" max="2023" required>
                                    </div>
                                    <div class="form-group">
                    ...
                    <!-- KATEGORI SAMPAI SINI -->


                    <div class="row" id="dp">
                        <div class="col-md mt-3 mb-2">
                            <div class="bg-mattOrangeLight px-3 pt-3 pb-1">
                                <h1 class="mb-2" align="center">FORM PENGAJUAN</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md mt-3 mb-2">
                            <div class="bg-mattBlackLight px-3 pt-3 pb-2">
                                <form>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="deskripsi" class="form-control" placeholder="Masukkan deskripsi"
                                            required></textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="unggahan">Unggah File (PDF/JPG):</label>
                                        <input type="file" id="unggahan" class="form-control-file" accept=".pdf, .jpg"
                                            required>
                                    </div>
                    ...
                    <div class="row" id="st">
                        <div class="col-md mt-3 mb-2">
                            <div class="bg-mattOrangeLight px-3 pt-3 pb-1">
                                <h1 class="mb-2" align="center">STATUS</h1>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="container-fluid text-center text-md-left">
                        <div class="row">
                            <div class="col-md-10 mt-md-0 mt-3">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium, tempore alias
                                    odio voluptatibus aperiam facilis autem? Deserunt porro assumenda optio ullam
                                    distinctio incidunt nulla nam similique laboriosam. Laudantium sapiente itaque
                                    aperiam eveniet beatae, ea, molestias laborum corrupti aliquam nesciunt rem illum,
                                    non quia officia repellat saepe temporibus at accusantium ad!</p>
                            </div>
